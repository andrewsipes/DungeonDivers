...
def print_heir(ob, levels=10):
    def recurse(ob, parent, depth):
        ...
        if ob.type == 'LIGHT' and ob.data.type == 'SPOT':
            ...
            print(spaces, ob.matrix_world)
            print(spaces, ob.data.color)
            print(spaces, ob.data.energy)
            print(spaces, ob.data.shadow_soft_size)
            print(spaces, ob.data.spot_size)
            print(spaces, ob.data.spot_blend)
                      
            # send to file
            file.write(spaces + ob.type + "\n")
            file.write(spaces + ob.name + "\n")
            file.write(spaces + ob.data.type + "\n")        
            file.write(spaces + str(ob.data.color) + "\n")
