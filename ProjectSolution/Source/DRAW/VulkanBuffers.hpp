...
{
	//*** HELPERS ***//
	inline void AddSceneData(entt::registry& registry, entt::entity entity)
	{
	...
	// Forward Declare Destroy methods
	...
	inline void Construct_VulkanGPUInstanceBuffer(entt::registry& registry, entt::entity entity) {
	...
	// Forward declare destroy for possible use in Update
	void Destroy_VulkanGPUInstanceBuffer(entt::registry& registry, entt::entity entity);
		
	inline void Update_VulkanGPUInstanceBuffer(entt::registry& registry, entt::entity entity) {
		...
		if (instances.size() > 0)
		{
			unsigned int sizeInBytes = sizeof(GPUInstance) * gpuBuffer.element_count;
			unsigned int frame;
	...
	inline void Destroy_VulkanGPUInstanceBuffer(entt::registry& registry, entt::entity entity) {
		auto& gpuBuffer = registry.get<VulkanGPUInstanceBuffer>(entity);
		auto& renderer = registry.get<VulkanRenderer>(entity);
	...
	inline void Construct_VulkanUniformBuffer(entt::registry& registry, entt::entity entity) {
	...
	inline void Update_VulkanUniformBuffer(entt::registry& registry, entt::entity entity) {
		...
		UTIL::matrixProxy.InverseF(camera.camMatrix, data.viewMatrix);
	...
	inline void Destroy_VulkanUniformBuffer(entt::registry& registry, entt::entity entity) {
		auto& gpuBuffer = registry.get<VulkanUniformBuffer>(entity);
		auto& renderer = registry.get<VulkanRenderer>(entity);
