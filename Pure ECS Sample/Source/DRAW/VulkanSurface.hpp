namespace DRAW {
	...
	inline void Update_GVulkanSurface(entt::registry& registry, entt::entity entity) {
		...
		if (+surface.StartFrame(2, settings.clrAndDepth)) {
			// use a view + "patch" to notify any renderers to run here
			// ...
	...
	CONNECT_COMPONENT_LOGIC()
	{
		...
		registry.on_update<GW::GRAPHICS::GVulkanSurface>().connect<Update_GVulkanSurface>();
